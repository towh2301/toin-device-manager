/**
 * @fileoverview Application Color Palette for TOIN VIETNAM CO., LTD.
 * The primary color is derived from the company's main logo and website theme (Navy/Dark Blue).
 */
