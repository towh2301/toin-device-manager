...
export const SortDropdown = ({
  ...
  return (
    <>
      <TouchableOpacity style={styles.dropdownTrigger} onPress={openModal}>
      ...
      >
        <Animated.View style={[styles.modalOverlay, { opacity: fadeAnim }]}>
          ...
          >
            ...
            <YStack backgroundColor={AppColors.primary} padding="$4" gap="$1">
            ...
            >
              <YStack gap="$2" padding="$4">
                {Object.values(DeviceType).map((opt) => {
                  ...
                  const displayName =
                    opt === DeviceType.ALL ? "Tất cả thiết bị" : opt;
                  ...
                  return (
                    ...
                    >
                      ...
                      <YStack
                        ...
                        height={42}
                        backgroundColor={
                          isActive ? "white" : AppColors.primaryLight + "20"
                        }
                        borderRadius="$3"
                      ...
                      <Text
                        ...
                        color={isActive ? "white" : AppColors.text}
                        style={{
                          marginLeft: 12,
                          flex: 1,
                        }}
          ...
          >
            ...
            <YStack padding="$3" gap="$2.5">
              ...
              <XStack
                ...
                borderRadius="$3"
              >
                <Ionicons name="pricetag" size={16} color={AppColors.primary} />
                <Text
                  fontSize={13}
                  color={AppColors.primary}
                  fontWeight="700"
              ...
              <XStack gap="$2" alignItems="center">
                ...
                >
                  ...
                  <Text fontSize={13} fontWeight="600" color={AppColors.text}>
                    {item.brand}
                  </Text>
                </YStack>
                <YStack
              ...
              <XStack gap="$2" alignItems="center">
                ...
                <Text fontSize={12} color={AppColors.textSecondary}>
                  ...
                  <Text fontWeight="600">
                    {item.purchasedDate
                      ? new Date(item.purchasedDate).toLocaleDateString("vi-VN")
                      : "N/A"}
                  </Text>
                </Text>
              </XStack>
    ...
    <YStack flex={1} backgroundColor={AppColors.background}>
      ...
      >
        ...
        >
          ...
          >
            <YStack gap="$1" flex={1}>
              <Text fontSize={26} fontWeight="900" color={AppColors.text}>
                Thiết bị
              </Text>
