...
type CallbackWithParams = (id: string, name: string) => void;

type SoftwareCardProps = {
	handleDeleteSoftware: CallbackWithParams;
	handleUnlinkSoftware: CallbackWithParams;
	...
	return (
		...
		>
			<YStack gap="$2">
				...
				<Pressable
					onPress={() =>
						toggleSoftwareExpand(deviceSoftware.softwareId)
					}
				>
				...
				{isExpanded && (
					<>
						...
						/>
						{/* Action Buttons */}
						<XStack key="action-buttons" gap="$2" marginBottom="$2">
							<Button
								key="btn-edit"
								flex={1}
								size="$2"
						...
						{/* Software Details */}
						<YStack key="details" gap="$2" marginTop="$2">
							{software?.licenseKey && (
